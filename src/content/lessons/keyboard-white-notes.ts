...
export const keyboardWhiteNotesLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'white-notes-choose', type: 'choice', prompt: '听到单音后，在 E、F、G 三个白键中选择对应音名。', skillIds: ['keyboard', 'pitch'], config: { choices: ['E', 'F', 'G'], trials: 4 }, feedback: { neighboringName: '你选了相邻音名，请用黑键分组重新确认这枚白键的位置。' } },
