...
export const keyboardWhiteNotesLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'white-notes-choose', type: 'choice', prompt: '试听候选单音，选择中央音区的 F 白键。', skillIds: ['keyboard', 'pitch'], config: { choices: ['E', 'F', 'G'], answer: 'F', trials: 4, audioOptions: { E: ['E4'], F: ['F4'], G: ['G4'] } }, feedback: { neighboringName: '你选了相邻音名，请用黑键分组重新确认这枚白键的位置。' } },
