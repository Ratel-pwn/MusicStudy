...
export const keyboardWhiteNotesLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'white-notes-choose', type: 'choice', prompt: '试听三枚相邻白键音，选择音高位于另外两枚之间的一枚。', skillIds: ['keyboard', 'pitch'], config: { choices: ['E', 'F', 'G'], answer: 'F', trials: 4, audioOptions: { E: ['E4'], F: ['F4'], G: ['G4'] } }, feedback: { neighboringName: '所选音位于三枚候选的一端，请再比较三枚音的相对高低。' } },
