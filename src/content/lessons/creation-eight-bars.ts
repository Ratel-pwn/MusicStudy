...
export const creationEightBarsLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'eight-bars-choose', type: 'choice', prompt: '比较两个结尾，选择在第八小节回到 C 音与 C 和弦的收束方案。', skillIds: ['creation', 'chord', 'pitch'], config: { choices: ['回到 C', '停在 D'], answer: '回到 C' }, feedback: { unresolvedEnding: '停在 D 保留了向前张力，八小节成品需要回到 C 获得收束。' } },
