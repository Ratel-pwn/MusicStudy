...
export const pitchMiddleCLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'middle-c-choose', type: 'choice', prompt: '在三个不同音区的 C 中，听辨并选择中央 C。', skillIds: ['pitch', 'keyboard'], config: { choices: ['C3', 'C4', 'C5'], answer: 'C4', audioOptions: { C3: ['C3'], C4: ['C4'], C5: ['C5'] } }, feedback: { selectedOuterC: '这个音是 C，但不在中央音区；请比较它与示范音的高度。' } },
