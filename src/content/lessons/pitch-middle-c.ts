...
export const pitchMiddleCLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'middle-c-choose', type: 'choice', prompt: '在三个不同音区的 C 中，听辨并选择中央 C。', skillIds: ['pitch', 'keyboard'], config: { choices: ['低音区', '中央音区', '高音区'], answer: '中央音区', audioOptions: { 低音区: ['C3'], 中央音区: ['C4'], 高音区: ['C5'] } }, feedback: { selectedOuterC: '这个音是 C，但不在中央音区；请比较它与示范音的高度。' } },
