...
export const pitchMiddleCLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'middle-c-transfer', type: 'studioTransfer', prompt: '把 B3–C4–D4 放进旋律轨，让中央 C 成为短句的停靠点。', skillIds: ['pitch', 'creation'], config: { targetTrack: 'melody', cadenceNote: 'C4' }, feedback: { cadenceOffCenter: '短句结尾需要落在 C4，当前停靠点没有回到中央 C。' } },
  ],
};
