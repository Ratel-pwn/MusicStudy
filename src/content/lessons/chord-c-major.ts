...
export const chordCMajorLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'c-chord-choose', type: 'choice', prompt: '听 C–E–G 与 C–F–G，选择具有 C 大三和弦稳定感的一组。', skillIds: ['chord', 'pitch'], config: { choices: ['C–E–G', 'C–F–G'], answer: 'C–E–G', audioOptions: { 'C–E–G': ['C4', 'E4', 'G4'], 'C–F–G': ['C4', 'F4', 'G4'] } }, feedback: { suspendedSound: 'C–F–G 中的 F 产生悬挂感，C 大三和弦的中间音应为 E。' } },
