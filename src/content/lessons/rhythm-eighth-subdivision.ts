...
export const rhythmEighthSubdivisionLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'eighth-choose', type: 'choice', prompt: '试听候选片段，选出八分音符均匀细分且没有抢拍的一段。', skillIds: ['pulse', 'rhythm'], config: { choices: ['均匀细分', '抢拍细分'], answer: '均匀细分', trials: 3, audioOptions: { 均匀细分: [{ midi: 72, offsetBeats: 0, durationBeats: 0.1 }, { midi: 72, offsetBeats: 0.5, durationBeats: 0.1 }, { midi: 72, offsetBeats: 1, durationBeats: 0.1 }, { midi: 72, offsetBeats: 1.5, durationBeats: 0.1 }], 抢拍细分: [{ midi: 72, offsetBeats: 0, durationBeats: 0.1 }, { midi: 72, offsetBeats: 0.28, durationBeats: 0.1 }, { midi: 72, offsetBeats: 1, durationBeats: 0.1 }, { midi: 72, offsetBeats: 1.22, durationBeats: 0.1 }] } }, feedback: { rushedSubdivision: '所选片段的第二下靠得太近，请检查每拍两下是否等距。' } },
