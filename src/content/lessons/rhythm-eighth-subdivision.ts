...
export const rhythmEighthSubdivisionLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'eighth-choose', type: 'choice', prompt: '听两个片段，选出八分音符均匀细分且没有抢拍的一段。', skillIds: ['pulse', 'rhythm'], config: { choices: ['片段 A', '片段 B'], trials: 3 }, feedback: { rushedSubdivision: '所选片段的第二下靠得太近，请检查每拍两下是否等距。' } },
