...
export const pitchHighLowLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'high-low-choose', type: 'choice', prompt: '听新的两枚音，选择第二枚音是更高还是更低。', skillIds: ['pitch'], config: { choices: ['更高', '更低'], trials: 4 }, feedback: { reversedDirection: '你判断成了相反方向，请把第二枚音和第一枚音的高度直接比较。' } },
