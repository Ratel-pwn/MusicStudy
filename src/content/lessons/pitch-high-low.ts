...
export const pitchHighLowLesson: Lesson = {
  ...
  prerequisiteIds: [],
  steps: [
    { id: 'high-low-listen', type: 'listen', prompt: '闭上眼听两枚音，留意第二枚音向上还是向下移动。', skillIds: ['pitch'], config: { pairs: [['C4', 'G4'], ['C4', 'F3']] }, feedback: { replayNeeded: '两枚音的距离还不清楚，请重听并只追踪第二枚音的方向。' } },
    ...
    { id: 'high-low-choose', type: 'choice', prompt: '听新的两枚音，选择第二枚音是更高还是更低。', skillIds: ['pitch'], config: { choices: ['更高', '更低'], trials: 4, audioOptions: { '更高': ['C4', 'G4'], '更低': ['C4', 'F3'] } }, feedback: { reversedDirection: '你判断成了相反方向，请把第二枚音和第一枚音的高度直接比较。' } },
