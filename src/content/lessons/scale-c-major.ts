...
export const scaleCMajorLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'c-scale-choose', type: 'choice', prompt: '比较两组音列，选择完整使用 C 到 C 八枚白键的一组。', skillIds: ['scale', 'pitch'], config: { choices: ['逐级白键', '含升号跳进'], answer: '逐级白键', audioOptions: { '逐级白键': ['C4', 'D4', 'E4', 'F4', 'G4'], '含升号跳进': ['C4', 'D#4', 'F#4', 'A4'] } }, feedback: { alteredScale: '所选音列含有升号或跳级，不符合 C 大调的八枚连续白键。' } },
