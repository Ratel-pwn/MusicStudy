...
export const rhythmQuarterPulseLesson: Lesson = {
  ...
  steps: [
    ...
    { id: 'quarter-pulse-choose', type: 'choice', prompt: '听两段节奏，选择哪一段始终保持每拍一下的稳定脉搏。', skillIds: ['pulse', 'rhythm'], config: { choices: ['稳定', '忽快忽慢'], answer: '稳定', trials: 3, audioOptions: { '稳定': [{ midi: 72, offsetBeats: 0, durationBeats: 0.15 }, { midi: 72, offsetBeats: 1, durationBeats: 0.15 }, { midi: 72, offsetBeats: 2, durationBeats: 0.15 }, { midi: 72, offsetBeats: 3, durationBeats: 0.15 }], '忽快忽慢': [{ midi: 72, offsetBeats: 0, durationBeats: 0.15 }, { midi: 72, offsetBeats: 0.7, durationBeats: 0.15 }, { midi: 72, offsetBeats: 2.1, durationBeats: 0.15 }, { midi: 72, offsetBeats: 2.75, durationBeats: 0.15 }] } }, feedback: { unstableSelected: '所选片段的拍击间距发生变化，请比较相邻拍之间的时间。' } },
